...
namespace u2dex
{
    ...
    public static class AdvancedSnapping
    {
        ...
        //[MenuItem(u2dexMenu.Root + "2D Transform Tool", false, 10150)]
        /*Add this to multiple menus (per plugin, if needed, etc.) by adding more MenuItems here...*/
        /*static void OpenWindow() //Not used anymore, but I'll keep it here for posterity and all that.
        {
            //Open a new window instance, or focus on the old one, if we have one open.
            var snap_Window = (AdvancedSnapping_Window)EditorWindow.GetWindow(typeof(AdvancedSnapping_Window),
                                            true, u2dexInfo.FullName + ": Transform Inspector Settings");
            snap_Window.Init();
            snap_Window.minSize = new Vector2(500, 300);
            snap_Window.maxSize = new Vector2(500, 300);
        }*/

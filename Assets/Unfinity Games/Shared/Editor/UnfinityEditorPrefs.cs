...
//Based off of and adapted from ArrayPrefs2 by Eric Haines
//http://wiki.unity3d.com/index.php/ArrayPrefs2

/// <summary>
/// Contains helpful classes to save complicated items (like arrays) into EditorPrefs.
/// </summary>

namespace UnfinityGames.Common.Editor
{
	public static class UnfinityEditorPrefs
	{
		...
		enum ArrayType { Float, Int32, Bool, String, Vector2, Vector3, Color }
